"""
Django settings for morning_math_dev_78000 project.
...
ROOT_URLCONF = 'morning_math_dev_78000.urls'
...
WSGI_APPLICATION = 'morning_math_dev_78000.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "morning_math_dev_78000 API",
    "DESCRIPTION": "API documentation for morning_math_dev_78000 App",
    "VERSION": "v1",
}
